...
from suumo_scrapy.utils.common import get_md5
from suumo_scrapy.items import SuumoArticleItem, ArticleItemLoader


class SuumoSpider(CrawlSpider):
    name = 'suumo'
    allowed_domains = ['suumo.jp']
    start_urls = ['https://suumo.jp/jj/chintai/ichiran/FR301FC001/?ar=030&bs=040&ta=13&sc=13103&cb=0.0&ct=9999999&et=9999999&cn=9999999&mb=0&mt=9999999&shkr1=03&shkr2=03&shkr3=03&shkr4=03&fw2=&srch_navi=1']
    ...
    def parse_item(self, response):
        ...
        item_loader = ArticleItemLoader(item=SuumoArticleItem(), response=response)
